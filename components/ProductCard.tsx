...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col rounded-xl border border-slate-200 bg-white overflow-hidden hover:shadow-lg hover:border-blue-200 transition-all duration-200"
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        <p className="text-xs font-medium text-blue-600 mb-1">{product.brand}</p>
