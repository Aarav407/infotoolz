...
const products = [
  ...
  { slug: "samsung-990-pro-2tb", name: "990 Pro 2TB", brand: "Samsung", categorySlug: "storage" },
  { slug: "wd-black-sn850x-1tb", name: "Black SN850X 1TB", brand: "WD", categorySlug: "storage" },
